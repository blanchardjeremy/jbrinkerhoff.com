...
PORTFOLIO_SECTIONS = [
    {
        'title': 'Art',
        'photoset_id': 72157629677986311,
    },
    {
        'title': 'Design',
        'photoset_id': 72157629313341834,
    },
    {
        'title': 'Objects',
        'photoset_id': 72157629313343524,
    },
]
...
MIDDLEWARE_CLASSES = [
    ...
    'mainsite.middleware.RemoveWWWRedirectMiddleware',
]
...
SECRET_KEY = os.environ.get('SECRET_KEY', '90x&rn=#$^yqEug(!f+_lf04qqax1--*7u-d6*nq0qciolw)#')
